            ...
            try:
                ...
                if not config.is_offline:
                    ...
                    params = {
                        ...
                        'param3': partner_id.id,
                        'param4': partner_id.name,
                ...
                if not config.is_offline:
                    ...
                    for rec in record.raw_workorder_line_ids:
                        ...
                        for resp in response.json():
                            if resp[''] == 0:
                                raise UserError(_("No Procesado Aún"))
                            if rec.product_id.default_code != resp[2].strip():
                                continue
                            qty = resp[4]
                            if not qty:
                            ...
                            rec.qty_done = resp[3]
                            rec.qty_to_consume = resp[3]
                            rec.qty_reserved = resp[3]
